function chatWidget(){
    ...
    this.insertChat = (colorSettings)=>{
      ...
      chatWidgetContainer.innerHTML = `
        ...
        <div id="chat-popup" class="chat-popup hidden ">
          ...
          <div id="chat-messages" class="chat-messages"><div id="chat-history" class="chat-messages"></div></div>
    ...
    this.openWebSoket = (app_id, api_hash, domain='wss://apidev.maia.work')=>{
